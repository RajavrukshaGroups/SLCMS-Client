...
const coursesData = [
  {
    ...
    desc: "Master the language of commerce — finance, taxation, and real-world accounting. GST-integrated training with industry practitioners.",
    longDesc:
      "A legacy program that transforms you into a financial architect. Specializations in Taxation, Corporate Accounting, and Financial Analytics.",
    img: BCOMImg,
    badge: "Legacy Program",
    color: "from-amber-500 to-orange-600",
    outcomes: ["GST Certification", "Tally Proficiency", "Financial Modeling"],
  },
  {
    ...
    desc: "Leadership, strategy & entrepreneurship. Develop business acumen through case studies and live projects.",
    longDesc:
      "Build the mindset of tomorrow's leaders. Focus on Marketing, HR Analytics, and Family Business Management.",
    img: BBAImg,
    badge: "Top Rated",
    color: "from-emerald-500 to-teal-600",
    outcomes: ["Project Management", "Leadership Skills", "Business Analytics"],
  },
  {
    ...
    title: "BCA",
    // slug: "bca",
    slug: "bca-colleges-in-bangalore",
    category: "ug",
    duration: "3 Years",
    creds: "180 Credits",
    desc: "Build digital tomorrow. Cloud computing, full-stack & AI foundations — code with creativity.",
    longDesc:
      "Industry-aligned curriculum with specializations in Cloud Computing, Cybersecurity, and Full-Stack Development.",
    img: BCAImg,
    badge: "Tech Forward",
    color: "from-purple-500 to-pink-600",
    outcomes: ["Cloud Computing", "Full-Stack Dev", "AI Fundamentals"],
  },
  {
    ...
    desc: "Explore life sciences with research labs, field projects & holistic approach to biology.",
    longDesc:
      "Comprehensive curriculum in Chemistry, Botany, Zoology with research opportunities and industry collaborations.",
    img: BscImg,
    badge: "Research Hub",
    color: "from-blue-500 to-cyan-600",
    outcomes: ["Lab Research", "Field Studies", "Environmental Science"],
  ...
  // },
  {
    ...
    title: "BA HEP",
    // slug: "ba-hep",
    slug: "ba-hep-colleges-in-bangalore",
    category: "ug",
    duration: "3 Years",
    creds: "180 Credits",
    desc: "Focused study in History, Economics, and Political Science for analytical and civic understanding.",
    longDesc:
      "An interdisciplinary program covering History, Economics, and Political Science, designed to build critical thinking, socio-political awareness, and analytical skills for diverse career paths.",
    img: BAImg,
    badge: "Academic Core",
    color: "from-rose-500 to-red-600",
  ...
  },
  {
    id: 6,
    title: "M.Com",
    slug: "mcom-colleges-in-bangalore",
    category: "pg",
    duration: "2 Years",
    creds: "120 Credits",
    desc: "Advanced financial strategy, analytics & corporate leadership. Elevate your commerce career.",
    longDesc:
      "Postgraduate excellence with focus on International Finance, Strategic Management, and Research Methodology.",
    img: MCOMImg,
    badge: "Postgraduate Excellence",
    color: "from-slate-600 to-gray-800",
    outcomes: ["Corporate Finance", "Strategic Leadership", "Research Skills"],
  ...
  // ----- NEW COURSES ADDED BELOW -----
  {
    ...
    longDesc:
      "Flagship postgraduate program with specializations in Marketing, Finance, HR, Operations, and Business Analytics. Live capstone projects and industry mentorship.",
  ...
  },
  {
    ...
    longDesc:
      "Advanced computing program covering AI/ML, Cloud Computing, Cybersecurity, and Full-Stack Development. Industry-driven curriculum with major project work.",
  ...
  return (
    ...
    >
      <div className="relative h-56 overflow-hidden">
        ...
        />
        <div
          className={`absolute top-4 right-4 bg-gradient-to-r ${course.color} text-white text-xs font-bold px-3 py-1.5 rounded-full shadow-md`}
        >
          {course.badge}
        </div>
        <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
...
const CourseCatalog = () => {
  ...
  const handleFormSubmit = (e) => {
    ...
    showToast(
      `🎓 Thank you ${formData.fullName}! Your journey inquiry for ${formData.course} is received.`,
    );
    setFormData({
      fullName: "",
      email: "",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-stone-50 via-white to-amber-50/20">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-stone-50 via-white to-amber-50/40">
        ...
        <div className="container mx-auto px-4 md:px-6 py-12 md:py-18 relative z-10">
          ...
          >
            ...
            <p className="text-stone-600 text-md md:text-lg max-w-3xl mx-auto mt-6 leading-relaxed">
              Where ambition meets mentorship. Our courses aren't just degrees —
              they're narratives of growth, resilience, and excellence.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div data-aos="fade-right" data-aos-duration="800">
              ...
              <p className="text-stone-600 leading-relaxed text-lg">
                At Srilakshmi college of management and science, we design
                experiences that go beyond textbooks. Each program is woven with
                real-world insights, ethics, and leadership — transforming
                students into architects of tomorrow.
              </p>
              <div className="mt-8 flex gap-3 flex-wrap">
                <div className="flex items-center gap-2 text-sm bg-stone-50 px-4 py-2 rounded-full">
                  <GraduationCap size={16} className="text-amber-600" /> 40+
                  Industry Experts
                </div>
                <div className="flex items-center gap-2 text-sm bg-stone-50 px-4 py-2 rounded-full">
                  <Globe size={16} className="text-amber-600" /> Global
                  Certifications
                </div>
              </div>
            </div>
      ...
      <section
        id="courses"
        className="py-20 bg-gradient-to-br from-stone-50 to-amber-50/20"
      >
        <div className="container mx-auto px-4 md:px-6">
          <div
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-stone-800">
              Choose your{" "}
              <span className="border-b-4 border-amber-400">path</span>
            </h2>
            <p className="text-stone-500 mt-4">
              Each program is crafted to bridge passion with profession, backed
              by modern pedagogy.
            </p>
          </div>
          ...
          >
            ...
            <div className="flex gap-3 flex-wrap">
              ...
              <FilterChip
                label="Undergraduate"
                value="ug"
                active={activeFilter === "ug"}
                onClick={setActiveFilter}
              />
              <FilterChip
                label="Postgraduate"
                value="pg"
                active={activeFilter === "pg"}
                onClick={setActiveFilter}
              />
            </div>
          </div>
      ...
      <section
        id="enquiry-section"
        className="py-20 bg-gradient-to-br from-stone-50 to-amber-50/30"
      >
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid md:grid-cols-2 gap-12 items-start">
            <div data-aos="fade-right">
              ...
              <p className="text-stone-600 text-lg leading-relaxed">
                Our advisors help you navigate the perfect course and career
                pathway. Share your dreams — we'll provide the roadmap.
              </p>
              <div className="mt-8 space-y-3">
                <div className="flex gap-3 items-center">
                  <CheckCircle size={18} className="text-amber-600" />
