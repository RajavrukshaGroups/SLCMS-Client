...
const ContactPage = () => {
  ...
  const API_ENDPOINT = process.env.REACT_APP_API_URL || 'https://your-backend.com/api/contact';
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setFormData({ fullName: '', email: '', subject: '', course: '', message: '' });
  ...
  return (
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8" style={{ backgroundColor: '#F9F8F4' }}>
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight" style={{ color: '#0F766E' }}>
            Contact Us
          </h1>
          <p className="text-lg text-gray-600 mt-2 max-w-2xl mx-auto">
            Leave us your info — we’re here to answer your questions and guide you.
          </p>
          <div className="w-20 h-1 mx-auto mt-4 rounded-full" style={{ backgroundColor: '#C8A95A' }}></div>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
              <h2 className="text-2xl font-semibold mb-3" style={{ color: '#0F766E' }}>
                The Srilakshmi Group of Institutions
              </h2>
              <p className="text-gray-700 leading-relaxed">
                An excellent environment consisting of a vast auditorium, smart board classes,
                and other necessary facilities to foster holistic learning.
              </p>
              <div className="flex flex-wrap gap-2 mt-4">
                {['Vast Auditorium', 'Smart Classes', 'Wi-Fi Campus', 'Library', 'Sports Complex'].map((f) => (
                  <span
                    key={f}
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 space-y-4">
              ...
              <div className="space-y-3 text-gray-700">
                <div>
                  ...
                  <p className="text-sm">
                    No. 29, Sri Gandada Kaval, Magadi Main Rd, Vishwaneedam Post,
                    Sunkadakatte, Bengaluru, Karnataka 560091, India.
                  </p>
                </div>
                <div>
                  <p className="font-medium">Email</p>
                  <a href="mailto:slgi2k3@gmail.com" className="text-sm hover:underline" style={{ color: '#0F766E' }}>
                    slgi2k3@gmail.com
                  </a>
                </div>
                <div>
                  ...
                  <div className="text-sm space-y-1">
                    <a href="tel:+919887365962" className="block hover:underline" style={{ color: '#0F766E' }}>
                      +91 98865 97362
                    </a>
                    <a href="tel:+919535003404" className="block hover:underline" style={{ color: '#0F766E' }}>
                      +91 95350 03404
                    </a>
                  </div>
                </div>
            ...
            <div
              ...
              style={{ backgroundColor: '#E6D3A3', color: '#0B5E55' }}
            >
              🔒 AICTE approved | ISO 9001:2015 certified | 24h response guarantee
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
            <div className="px-6 py-5" style={{ backgroundColor: '#0F766E' }}>
              ...
              <p className="text-teal-100 text-sm">Fill out the form below and we’ll get back to you promptly.</p>
            </div>

            <div className="p-6">
              {submitSuccess && (
                <div className="mb-5 p-3 rounded-xl text-sm flex items-center gap-2" style={{ backgroundColor: '#E6D3A3', color: '#0B5E55' }}>
                  <span className="text-lg">✓</span> Thank you! Your message has been sent. Our team will contact you soon.
                </div>
              )}
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <button
                  ...
                  onMouseEnter={(e) => (e.currentTarget.style.backgroundColor = '#0B5E55')}
