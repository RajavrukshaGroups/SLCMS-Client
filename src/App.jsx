...
export default function App() {
  ...
  // Auto-open modal logic (currently commented, but kept as is)
  // useEffect(() => {
  ...
  return (
    <Router>
      ...
      <div className="flex flex-col min-h-screen">
        ...
        {/* Concession floating button (conditionally visible) */}
        {showFloating && (
          <div
            onClick={() => {
              setIsOpen(true);
        ...
        {/* <a
          ...
          className={`
            ...
            hover:scale-105 hover:bg-[#20b859]
            focus:outline-none focus:ring-2 focus:ring-green-400
            ${showFloating ? "bottom-24" : "bottom-6"}
          `}
        >
