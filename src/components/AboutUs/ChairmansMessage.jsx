...
//            <img src={Founder} alt="Founder" className="w-200 h-100 rounded-2xl mx-auto mb-6" /> 
...
import { motion } from 'motion/react';
import { Quote, Globe, BookOpenCheck, CircleStar } from 'lucide-react';
import cleraMam from "../../assets/clera-mam.jpg";
import Founder from "../../assets/founder.jpg";
    ...
    <section id="chairmans-message" className="py-24 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center mb-12">
          <img
            src={Founder}
            alt="Founder of Sri Lakshmi College"
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-12">
            ...
            >
              ...
              <h4 className="text-2xl font-bold text-blue-900 mb-4">ASPIRATION</h4>
              <p className="text-blue-800/80 leading-relaxed">
                Sri Lakshmi College of Management and Science started a glorious beginning in 2015,
                adopting the CBSE syllabus managed by the Dhanvantari Trust, adorning it as a jewel
                in the crown of the Sri Lakshmi Group of Institutions.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-zinc-600 leading-relaxed">
                The urge of our founders to tap education from the grassroots level has paved the
                way for the school, which endeavours to bring about quality education in all the
                tiny tots and nurture them with great care academically to mould the youth of today
                into responsible future citizens of India and the world at large to realise the
                dreams come true of global education and create the "Vishwa kutumbakam".
              </p>
            </motion.div>
          </div>
          ...
          <div className="space-y-12">
            ...
            >
              ...
              <div className="space-y-6 text-zinc-600 leading-relaxed">
                <p>
                  Rooted with a mission of imparting education to all sections of society, Sri
                  Lakshmi College of Management and Science started under the Danavanthri Educational
                  Trust. The college has expanded in all directions, attracting the students right
                  from Nepal to Kanyakumari and from Mizoram to Gujarat.
                </p>
                <p>
                  This is because the college encompasses knowledge, skills and values where
                  teaching is done through experimental learning and discipline is interlaced by
                  friendly mentoring. The college also aims at providing exemplary education and
                  professionals to the dynamic and complex global society. Our curriculum, teaching
                  and services demonstrate that we value the diverse profiles of our learners.
                </p>
                <div className="flex gap-4 items-start bg-zinc-50 p-6 rounded-3xl border border-zinc-100">
                  <BookOpenCheck className="w-12 h-12 text-blue-600 mt-1 flex-shrink-0" />
                  <p className="text-sm">
                    The college also penetrates through research, projects, guest lectures, seminars
                    and workshops, which fortifies the students to emerge as functional successes,
                    ready to take on career challenges in all the fields.
                  </p>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              className="pt-10 border-t border-zinc-100 flex items-center gap-6"
            >
              <div className="w-20 h-20 rounded-full overflow-hidden bg-zinc-200 shadow-lg flex-shrink-0">
                <img
                  src={cleraMam}
                  alt="Smt. Clara Robert, Administrator"
