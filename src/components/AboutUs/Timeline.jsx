...
export default function Timeline() {
  ...
  return (
    <section ref={containerRef} className="py-24 bg-zinc-50 relative overflow-hidden">
      {/* ✅ Decent Pattern Overlay – Dots (subtle, professional) */}
      <div 
      ...
      {/* Optional: Soft blurred circles for depth (remove if not needed) */}
      <div className="absolute -top-32 -left-32 w-96 h-96 bg-lime-200/30 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute -bottom-32 -right-32 w-96 h-96 bg-lime-200/30 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="mb-20">
          ...
          >
            The Flashback to{" "}
            <span className="text-lime-600">Sri Lakshmi College's</span>{" "}
            History
          </motion.h2>
        </div>
