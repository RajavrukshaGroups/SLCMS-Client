...
const Navbar = () => {
  ...
  const navItems = [
    ...
    { name: "IAS/KAS", href: "/ias-kas-upsc-training-bangalore" },
    {
      ...
      href: "/courses",
      dropdown: [
        { name: "B.com", href: "/course/bcom-colleges-bangalore" },
        { name: "BBA", href: "/course/bba-colleges-bangalore" },
        { name: "BCA", href: "/course/bca-colleges-in-bangalore" },
        { name: "B.Sc", href: "/course/bsc-cbz-colleges-bangalore" },
        { name: "BA", href: "/course/ba-hep-colleges-in-bangalore" },
        { name: "M.Com", href: "/course/mcom-colleges-in-bangalore" },
        { name: "MCA", href: "/course/mca-colleges-bangalore" },
        { name: "MBA", href: "/course/mba-colleges-bangalore" },
      ],
    },
