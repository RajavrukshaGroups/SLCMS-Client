...
const Navbar = () => {
  ...
  const navItems = [
    ...
    { name: "IAS/KAS", href: "/ias-kas-upsc-training-bangalore" },
    {
      name: "Courses",
      href: "/courses",
      dropdown: [
        { name: "B.com", href: "/course/bcom-colleges-in-bangalore" },
        { name: "BBA", href: "/course/bba-colleges-in-bangalore" },
        { name: "BCA", href: "/course/bca-colleges-in-bangalore" },
        { name: "B.Sc", href: "/course/bsc-cbz-colleges-in-bangalore" },
        { name: "BA", href: "/course/ba-hep-colleges-in-bangalore" },
        { name: "M.Com", href: "/course/mcom-colleges-in-bangalore" },
        { name: "MCA", href: "/course/mca-colleges-in-bangalore" },
        { name: "MBA", href: "/course/mba-colleges-in-bangalore" },
      ],
    },
    ...
    { name: "Placements", href: "/placements" },
    {
      ...
      dropdown: [
        {
          name: "LOA",
          href: "https://srilakshmimanagement.org/wp-content/uploads/2025/02/LOA-Report-24-25.pdf",
        },
        {
          name: "AICTE Mandatory Disclosure",
          href: "https://srilakshmimanagement.org/wp-content/uploads/2025/01/AICTE.pdf",
        },
        { name: "Student and Faculty Feedback", href: "/feedback" },
      ],
    },
    { name: "Contact", href: "/contact" },
    { name: "Get Clearance Form", href: "/fee-clearance-form" },
  ];
    ...
    >
      ...
      <div className="w-full max-w-[1440px] mx-auto flex flex-col lg:flex-row h-auto lg:h-24">
        ...
        <div className="hidden lg:flex flex-col flex-1">
          ...
          <div
            id="top-nav-row"
            className="flex items-center justify-between border-b border-gray-100 h-1/2"
          >
            <div className="flex items-center gap-8 px-8">
              ...
              {/* <div className="flex items-center gap-3 ml-4">
                <button onClick={()=>navigate("/staff")} className="flex items-center gap-2 px-4 py-1.5 bg-gray-50 rounded-full text-[13px] text-gray-700 hover:bg-gray-100 transition-colors">
          ...
          <div
            id="bottom-nav-row"
            className="flex items-center gap-8 px-8 h-1/2"
          >
                ...
                return (
                  <div
                    ...
                    className={`relative h-full flex items-center ${
                      item.name === "Get Clearance Form" ? "ml-auto" : ""
                    }`}
                    onMouseEnter={() =>
