      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            <Link to="/" className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <span className="font-display text-xl font-bold tracking-wider text-white leading-none">
                  SLCMS
                </span>
            ...
            <p className="text-sm leading-relaxed text-slate-400">
              ...
              innovative learning environments. Sri Lakshmi College of
              Management & Science is committed to excellence.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              {["About", "Courses", "Admissions", "Placements", "Gallery"].map(
                (item) => (
                  <li key={item}>
                    <Link
            ...
            <ul className="space-y-5">
              <li className="flex gap-4">
                ...
                <span className="text-sm text-slate-400">
                  {/* 123 Academic Square, Knowledge Park, */}
              ...
              <li className="flex gap-4">
                ...
                <span className="text-sm text-slate-400">+91 9902627202</span>
              </li>
              <li className="flex gap-4">
        ...
        <div className="pt-10 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-xs text-slate-500">
            © {new Date().getFullYear()} Sri Lakshmi College of Management &
