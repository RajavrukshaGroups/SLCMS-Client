...
const courses = [
  {
    ...
    color: "bg-blue-500",
    link: "/course/bba-colleges-in-bangalore",
  },
  {
  ...
  },
  {
    ...
    color: "bg-amber-500",
    link: "/course/bcom-colleges-in-bangalore",
  },
  {
    ...
    color: "bg-rose-500",
    link: "/course/bsc-cbz-colleges-in-bangalore",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <h2 className="text-4xl md:text-5xl font-display font-bold text-slate-900 mb-6">
            Choose Your <span className="text-primary italic">Path</span> to
            Success
          </h2>
          <p className="text-slate-600">
            Our diverse range of undergraduate programs is designed to equip
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {courses.map((course, i) => (
            <a href={course.link}>
              ...
              >
                <div
                  className={`w-14 h-14 rounded-2xl ${course.color} text-white flex items-center justify-center mb-8 shadow-lg group-hover:scale-110 transition-transform duration-500`}
                >
