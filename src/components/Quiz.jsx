...
//             exit={{ opacity: 0, y: -20 }}
//             className="bg-white rounded-3xl shadow-sm border border-slate-100 p-5 md:p-8"
//           >
//             <h2 className="text-xl md:text-xl font-bold text-slate-900 mb-8 leading-relaxed">
...
//                   className={cn(
//                     "w-full p-3 rounded-2xl text-left font-medium transition-all border-2 flex items-center justify-between group",
