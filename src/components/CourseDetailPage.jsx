...
const courseDetailsContent = {
  "bcom-colleges-bangalore": {
    ...
    seo: {
      title:
        "Best BCom Colleges in Bangalore | Top BCom Colleges in Bangalore | Sri Lakshmi College",

      description:
        "Looking for the best BCom colleges in Bangalore? Sri Lakshmi College of Management & Science, Sunkadakatte, is among the top BCom colleges in Bangalore, offering industry-focused BCom programs, experienced faculty, and career-oriented education.",
...
After completion of B.Com, you can apply in any organization for the post of accountant. Every company requires accountant to keep track the profit and loss of their company. One must have knowledge in areas like Basic Principles of Accountancy, Cost Accounting and Management Accounting to be an accountant. Other than accountant, there are many career options in this field.`,
  ...
  "bba-colleges-bangalore": {
    ...
    seo: {
      title:
        "Best BBA Colleges in Bangalore | Top BBA Colleges in Bangalore | Sri Lakshmi College",

      description:
        "Looking for the best BBA colleges in Bangalore? Sri Lakshmi College of Management & Science, Sunkadakatte, is among the top BBA colleges in Bangalore, offering industry-focused BBA programs, experienced faculty, and career-oriented learning.",
...
Many graduates pursue MBA for advanced career growth. With experience, BBA graduates can move into senior management positions or start their own ventures.`,
  ...
  "bca-colleges-in-bangalore": {
    ...
    seo: {
      title:
        "Best BCA Colleges in Bangalore | Top BCA Colleges in Bangalore | Sri Lakshmi College",

      description:
        "Looking for the best BCA colleges in Bangalore? Sri Lakshmi College of Management & Science, Sunkadakatte, is among the top BCA colleges in Bangalore, offering industry-focused BCA programs, experienced faculty, modern computer labs, and career-oriented learning.",

      keywords:
        "best bca colleges in bangalore, top bca colleges in bangalore, bca colleges in bangalore, bachelor of computer applications colleges in bangalore, best bca course in bangalore, sri lakshmi college of management & science",

      canonical:
        "https://srilakshmimanagement.org/course/bca-colleges-in-bangalore",

      h1: "Study at One of the Best & Top BCA Colleges in Bangalore – Sri Lakshmi College of Management & Science",
    },
...
With additional certifications, BCA graduates can specialize in emerging technologies like AI, Cloud Computing, or Cybersecurity. Many pursue MCA or MBA for further growth.`,
  ...
  "bsc-cbz-colleges-bangalore": {
    ...
    seo: {
      title:
        "Best BSC Colleges in Bangalore | Top BSC Colleges in Bangalore | Sri Lakshmi College",

      description:
        "Looking for the Best BSC colleges in Bangalore? Sri Lakshmi College of Management & Science, Sunkadakatte, is among the top BSC colleges in Bangalore, offering industry-focused BSC programs, experienced faculty, modern computer labs, and career-oriented learning.",
...
Opportunities exist in research laboratories, pharmaceutical companies, environmental agencies, and academic institutions.`,
  ...
  "ba-hep-colleges-in-bangalore": {
    id: "ba-hep",
    title: "BA HEP",
    fullTitle: "Bachelor of Arts in History, Economics & Political Science",
    seo: {
      title:
        "Best BA Colleges in Bangalore | Top BA Colleges in Bangalore | Sri Lakshmi College",
      description:
        "Looking for the best BA colleges in Bangalore? Sri Lakshmi College of Management & Science, Sunkadakatte, is among the top BA colleges in Bangalore, offering quality BA programs, experienced faculty, and career-focused education.",
      keywords:
        "best ba colleges in bangalore, top ba colleges in bangalore, ba colleges in bangalore, ba hep colleges in bangalore, bachelor of arts colleges in bangalore, sri lakshmi college",
      canonical:
        "https://srilakshmimanagement.org/course/ba-hep-colleges-in-bangalore",
      h1: "Top BA Colleges in Bangalore",
    },
    duration: "3 Years",
    creds: "180 Credits",
    level: "Undergraduate",
...
With further studies, students can specialize in law, economics, political science, or international relations.`,
  ...
  "mcom-colleges-in-bangalore": {
    id: "mcom",
    title: "M.Com",
    fullTitle: "Master of Commerce",
    seo: {
      title:
        "Best MCom Colleges in Bangalore | Top MCom Colleges in Bangalore | Sri Lakshmi College",

      description:
        "Looking for the best MCom colleges in Bangalore? Sri Lakshmi College of Management & Science, Sunkadakatte, is among the top MCom colleges in Bangalore, offering advanced commerce education, experienced faculty, and strong career opportunities.",

      keywords:
        "best mcom colleges in bangalore, top mcom colleges in bangalore, mcom colleges in bangalore, master of commerce colleges in bangalore, best mcom course in bangalore, mcom admissions bangalore, sri lakshmi college of management & science",

      canonical:
        "https://srilakshmimanagement.org/course/mcom-colleges-in-bangalore",

      h1: "Study at One of the Best & Top MCom Colleges in Bangalore – Sri Lakshmi College of Management & Science",
    },
...
Senior roles include Financial Controller, Investment Banker, Corporate Treasurer, and Professor. The program also prepares students for competitive exams like UGC NET for academic careers.`,
  ...
  "mba-colleges-bangalore": {
    ...
    seo: {
      title:
        "Best MBA Colleges in Bangalore | Top MBA Colleges in Bangalore | Sri Lakshmi College",

      description:
        "Looking for the best MBA colleges in Bangalore? Sri Lakshmi College of Management & Science, Sunkadakatte, is among the top MBA colleges in Bangalore, offering industry-focused MBA programs, expert faculty, placement support, and career-oriented learning.",
...
Top recruiters offer roles in strategy, consulting, banking, e-commerce, and technology. With experience, MBA professionals advance to C-suite positions like CEO, CFO, or COO. The degree also provides a strong foundation for starting your own venture.`,
  ...
  "mca-colleges-bangalore": {
    ...
    seo: {
      title:
        "Best MCA Colleges in Bangalore | Top MCA Colleges in Bangalore | Sri Lakshmi College",

      description:
        "Looking for the best MCA colleges in Bangalore? Sri Lakshmi College of Management & Science, Sunkadakatte, is among the top MCA colleges in Bangalore, offering advanced computer applications, expert faculty, modern labs, and strong career opportunities.",
...
const CourseDetailPage = () => {
  ...
  const handleFormSubmit = (e) => {
    ...
    showToast(
      `Thank you ${formData.fullName}! We'll contact you about ${course.title}.`,
    );
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-stone-50 to-amber-50/20">
        <div className="text-center">
          ...
          <Link
            to="/"
            className="text-amber-600 hover:text-amber-700 flex items-center gap-2 justify-center"
          >
  ...
  return (
    <>
      <Helmet>
        <title>{course.seo?.title || course.title}</title>
        ...
        <link
          rel="canonical"
          href={course.seo?.canonical || window.location.href}
        />

        <meta name="robots" content="index, follow" />

        <meta property="og:title" content={course.seo?.title || course.title} />
        ...
        <meta
          property="og:url"
          content={course.seo?.canonical || window.location.href}
        />
      ...
      <div className="min-h-screen bg-gradient-to-br from-stone-50 via-white to-amber-50/20">
        ...
        <section className="relative overflow-hidden">
          <div className="relative h-80 md:h-96 overflow-hidden">
            ...
            />
            <div
              className={`absolute inset-0 bg-gradient-to-r ${course.color} opacity-15`}
            />
        ...
        <div className="container mx-auto px-4 md:px-6 py-12">
          <div className="grid lg:grid-cols-3 gap-12">
              ...
              <div data-aos="fade-up" data-aos-delay="100">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {course.keyHighlights.map((highlight, idx) => (
                    <div
                      key={idx}
                      className="flex items-center gap-2 text-stone-600 bg-stone-50 p-3 rounded-xl"
                    >
                      <CheckCircle
                        size={16}
              ...
              <div data-aos="fade-up" data-aos-delay="200">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                  {course.syllabus.map((subject, idx) => (
                    <div
                      key={idx}
                      className="flex items-center gap-2 text-stone-600 text-sm bg-stone-50 p-2 rounded-lg"
                    >
            ...
            <div className="space-y-6">
              ...
              {/* Apply Card */}
              <div
                className="bg-white rounded-2xl p-6 shadow-lg border border-stone-100 sticky top-24"
                data-aos="fade-left"
              >
                {/* Badge */}
